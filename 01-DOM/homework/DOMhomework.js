...
//const developed= document.querySelector("#createdBy").innerHTML+=" Daniel"
document.querySelector("#createdBy").innerHTML+=" Daniel Viasus !!";
...
function buildToDos(toDos) { // Tu código acá:
  const mapeo=toDos.map(function(elemento,index){
...
function displayToDos() {
  ...
  //arr.map(function(elemento,index){ codigo que quieras })
}
